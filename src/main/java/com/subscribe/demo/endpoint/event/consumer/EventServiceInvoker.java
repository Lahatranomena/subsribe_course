package com.subscribe.demo.endpoint.event.consumer;

import com.subscribe.demo.PojaGenerated;
import com.subscribe.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.subscribe.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.subscribe.demo.service.event."
