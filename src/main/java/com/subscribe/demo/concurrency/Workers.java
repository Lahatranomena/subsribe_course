package com.subscribe.demo.concurrency;

import static com.subscribe.demo.concurrency.ThreadRenamer.getRandomSubThreadNamePrefixFrom;
import static com.subscribe.demo.concurrency.ThreadRenamer.renameThread;
